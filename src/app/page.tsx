  ...
  return (
    <div className="min-h-screen bg-[#0a1628] flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 text-center max-w-3xl mx-auto">
        ...
        <h1 className="text-[clamp(2.5rem,8vw,5rem)] font-bold leading-[0.95] tracking-tight mb-6 text-white">
          Audio rooms that<br />
        ...
        <div className="flex gap-3 flex-wrap justify-center">
          {authenticated ? (
            <Link
              href="/fishbowlz"
              className="bg-[#f5a623] text-[#0a1628] font-bold px-8 py-3.5 rounded-full text-base hover:bg-[#d4941f] transition-all hover:shadow-[0_0_30px_rgba(245,166,35,0.3)]"
            >
              Enter Rooms →
            </Link>
          ) : (
          ...
          <Link
            href="/fishbowlz"
            className="border border-white/10 text-gray-300 font-medium px-8 py-3.5 rounded-full text-base hover:bg-white/5 transition-colors"
          >
            Browse Rooms
          </Link>
        </div>
      ...
      {/* Features */}
      <div className="max-w-4xl mx-auto px-6 py-20 grid grid-cols-1 sm:grid-cols-3 gap-8">
        {[
